...
jest.mock('@/components/pages/contracts/contract-form', () => ({
  ...
  default: (props: { session?: Session; id?: number }) => {
    ...
    return React.createElement(
      'div',
      null,
      `CONTRACT_FORM_CLIENT_MARKER:${JSON.stringify(props?.session ?? null)}:ID=${props?.id ?? ''}`,
    );
  },
}));
...
describe('ContractEditPage server component', () => {
  ...
  it('renders ContractFormClient with session and id when session exists', async () => {
