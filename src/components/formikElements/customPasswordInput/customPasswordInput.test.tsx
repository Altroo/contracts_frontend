...
describe('CustomPasswordInput', () => {
  ...
  it('renders as disabled when disabled is true', () => {
    render(
      <CustomPasswordInput id="password-input" value="" label="Password" disabled onChange={() => {
      }} theme={theme}/>,
    );
  ...
  it('toggles password visibility when icon is clicked', () => {
    render(
      <CustomPasswordInput id="password-input" value="secret" label="Password" onChange={() => {
      }} theme={theme}/>,
    );
