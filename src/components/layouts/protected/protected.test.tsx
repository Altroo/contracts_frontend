...
describe('Protected component', () => {
	it('renders children when is_staff is true (default permission)', () => {
		(usePermission as jest.Mock).mockReturnValue({ is_staff: true, can_view: false, can_print: false, can_create: false, can_edit: false, can_delete: false });
	...
	it('renders access denied message when is_staff is false (default permission)', () => {
		(usePermission as jest.Mock).mockReturnValue({ is_staff: false, can_view: false, can_print: false, can_create: false, can_edit: false, can_delete: false });
	...
	it('renders children when specific permission is granted', () => {
		(usePermission as jest.Mock).mockReturnValue({ is_staff: false, can_view: true, can_print: false, can_create: false, can_edit: false, can_delete: false });
