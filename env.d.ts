declare namespace NodeJS {
  interface ProcessEnv {
    ...
    // Notifications
    NEXT_PUBLIC_CONTRACTS_NOTIFICATION_ROOT: string;
    NEXT_PUBLIC_CONTRACTS_NOTIFICATIONS: string;
    NEXT_PUBLIC_CONTRACTS_NOTIFICATION_PREFERENCES: string;
    NEXT_PUBLIC_CONTRACTS_NOTIFICATION_MARK_READ: string;
    NEXT_PUBLIC_CONTRACTS_NOTIFICATION_UNREAD_COUNT: string;
  }
}
